...
public class RamSnakeGame extends NonBlockingGame{
    static int[] boardSize;                 // controls board size (rows, cols)
    ...
    public static void main(String args[]) {
        ...
        RamSnakeGame mg = new RamSnakeGame(ASSIGNMENT_NUMBER, "USERNAME", "API_KEY",
    ...
    private void draw() {
        ...
        // Use a loop to tranverse the Sake arraylist and
